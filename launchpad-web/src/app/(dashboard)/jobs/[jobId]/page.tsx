...
const RADAR_DATA = [
  { skill: 'React',      user: 95, required: 85 },
  { skill: 'TypeScript', user: 80, required: 90 },
  { skill: 'Node.js',    user: 60, required: 80 },
  { skill: 'SQL',        user: 40, required: 70 },
  { skill: 'Testing',    user: 55, required: 75 },
  { skill: 'CSS/UX',     user: 75, required: 60 },
];
