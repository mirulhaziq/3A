    ...
    >
      ...
      <div className="flex gap-2.5">
        <motion.button
          ...
          onClick={() => {
            haptic('light');
            router.push(`/jobs/${resume.jobId}/tailored`);
          }}
  ...
  return (
    <div className="min-h-screen bg-[#F5F0E8] flex">
      ...
      <div className="flex-1 lg:ml-[220px] flex flex-col min-h-screen">
        ...
        {/* Content */}
        <div className="flex-1 px-4 lg:px-8 py-6 pb-28 lg:pb-8 max-w-3xl w-full mx-auto">
          ...
          {/* Search */}
          <div className="flex items-center gap-2 bg-white border border-[#E8E0D0] rounded-xl px-4 h-11 mb-4">
          ...
          <div className="hidden lg:flex gap-4 mb-6">
            {[
              ...
              <div
                key={stat.label}
                className="flex-1 bg-white rounded-2xl border border-[#E8E0D0] p-4 text-center"
              >
                <p className="text-[24px] font-extrabold" style={{ color: stat.color }}>{stat.value}</p>
                <p className="text-[12px] text-[#6B6B6B] mt-0.5">{stat.label}</p>
              </div>
            ))}
          </div>
          ...
          <AnimatePresence mode="wait">
            {filtered.length > 0 ? (
              ...
              >
                ...
                {/* CTA at bottom */}
                <div className="mt-2 bg-white rounded-2xl border border-[#E8E0D0] p-5 flex items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[12px] text-[#6B6B6B] mt-0.5">
                      Each tailored resume boosts your match score by up to 20%.
                    </p>
                  </div>
                  <Link
                    href="/jobs"
                    className="flex items-center gap-1 text-[13px] font-bold text-[#FFC800] flex-shrink-0"
